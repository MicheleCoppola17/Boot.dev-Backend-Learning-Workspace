...
1. For each iteration, use i with bracket notation to get the items at the same index from both lists.
2. Check if the level in old_character_levels is less than the level in the new_character_levels.
